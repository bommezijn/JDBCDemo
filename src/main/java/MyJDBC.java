...
public class MyJDBC {
    ...
    private static final String DB_DEFAULT_DATABASE = "bommezij_Corendon";
    private static final String DB_DEFAULT_SERVER_URL = "162.144.12.174:3306";
    private static final String DB_DEFAULT_ACCOUNT = "bommezij_master";
    private static final String DB_DEFAULT_PASSWORD = "master";
    ...
    public static void createTestDatabase(String dbName) {  
        ...
        MyJDBC sysJDBC = new MyJDBC("bommezij_Corendon");
        ...
        myJDBC.executeUpdateQuery("CREATE TABLE IF NOT EXISTS Airport ("
                + " IATACode VARCHAR(45) NOT NULL PRIMARY KEY,"
                + " Name VARCHAR(45),"
                + " TimeZone INT(3) )");
        ...
        myJDBC.executeUpdateQuery("INSERT INTO Airport VALUES ("
                + "'BSA', 'Bayzambmo Saye Airport', 3 )");
        myJDBC.executeUpdateQuery("INSERT INTO Airport VALUES ("
                + "'TES', 'Test World Airport', 99 )");
